...
async def tastytrade_transaction(
    tt, action, stock, amount, price, time, DRY=True, ctx=None
):
    print()
    print("==============================")
    print("Tastytrade")
        ...
        if not DRY:
            ...
            if day_trade_ok:
                ...
                try:
                    ...
                    if (
                        error[0] == "Unknown remote error 422"
                        or error[0] in "Order execution failed "
                    ):
                        ...
                        if action == "buy":
                            ...
                            new_order = order_setup(
                                order_type, stock_price, stock, amount
                            )
                        elif action == "sell":
                            stock_limit = D(stock_limit[0].lowLimitPrice)
                            if stock_limit.is_nan():
